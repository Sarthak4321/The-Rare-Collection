...
export default function DatePlanningRedesign() {
  ...
  return (
    <main className={cn(
      ...
      {/* Custom Styles for Typography & UI */}
      <style jsx global>{`
                @import url('https://fonts.googleapis.com/css2?family=Crimson+Pro:ital,wght@0,200..900;1,200..900&family=Inter:wght@100..900&display=swap');
                ...
                /* Hide Site-wide Navbar and Footer */
                nav, header, footer {
                    display: none !important;
                }
                
                /* Ensure main content handles its own layout */
                main {
                    margin: 0 !important;
                    padding: 0 !important;
                }
